                        ...
                        <div class="col-xs-12">
                            <div class="bradcaump__inner">
                                <nav class="bradcaump-inner">
                                  ...
                                  <span class="breadcrumb-item active">Claim cart</span>
                                </nav>
                            </div>
                        </div>
                    </div>
                        ...
                        <form action="#">               
                            <div class="table-content table-responsive">
                                <table>
                                    <thead>
                                        <tr>
                                            <th class="product-thumbnail">Lost Items</th>
                                            <th class="product-name">Name of Lost Item </th>
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="buttons-cart--inner">
                                        ...
                                        <div class="buttons-cart checkout--btn">
                                            <a href="<?php echo SITE_PATH?>checkout.php">Claim</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
