                ...
                <div class="row">
										...
										<div class="accordion__body">
											<div class="bilinfo">
													...
													<div class="row">
														<div class="col-md-12">
															<div class="single-input">
																<input type="text" name="address" placeholder="Hostel Block" required>
															</div>
														</div>
														<div class="col-md-6">
															<div class="single-input">
																<input type="text" name="city" placeholder="Hostel Room" required>
															</div>
														</div>
														<div class="col-md-6">
															<div class="single-input">
																<input type="text" name="pincode" placeholder="Contact Number" required>
															</div>
														</div>
                    ...
                    <div class="col-md-4">
                        <div class="order-details">
                            <h5 class="order-details__title">Your Claims</h5>
