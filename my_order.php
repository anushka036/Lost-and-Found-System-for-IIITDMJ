                            ...
                            <form action="#">
                                <div class="wishlist-table table-responsive">
                                    <table>
                                        <thead>
                                            <tr>
                                                <th class="product-thumbnail">Claim ID</th>
                                                <th class="product-name"><span class="nobr">Claim Date</span></th>
                                                <th class="product-price"><span class="nobr"> Address </span></th>
                                                
												<th class="product-stock-stauts"><span class="nobr"> Claim Status </span></th>
                                            </tr>
                                        </thead>
                                        <tbody>
											<?php
